...
music_icon="$(tmux_get '@tmux_power_music_icon' '🎧')"
...
user=$(whoami)
LS="#[fg=$G04,bg=$TC,bold] $user_icon $user@#h #[fg=$TC,bg=$G02,nobold]$right_arrow_icon#[fg=$TC,bg=$G02] $session_icon #S "
if "$show_upload_speed"; then
    LS="$LS#[fg=$G02,bg=$G05]$right_arrow_icon#[fg=$TC,bg=$G05] $upload_speed_icon#{upload_speed} #[fg=$G05,bg=$BG]$right_arrow_icon"
else
...
RS="#[fg=$TC,bg=$G02] $time_icon %T #[fg=$TC,bg=$G02]$left_arrow_icon#[fg=$G04,bg=$TC] $date_icon %F "
RS="#[fg=$G12,bg=$G06] $music_icon #{spotify_status} #[fg=$G02,bg=$G06]$left_arrow_icon$RS"
